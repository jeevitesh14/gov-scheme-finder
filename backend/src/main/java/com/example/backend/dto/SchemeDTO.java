...
public class SchemeDTO {
    ...
    public SchemeDTO(Long id, String name, String description, CategoryType category, String state, GenderType gender, CasteType caste, Integer ageMin, Integer ageMax, Double incomeLimit, Boolean disability, Boolean bpl, Boolean widow, Boolean minority, String applyLink) {
        this.id = id;
        this.name = name;
